...
from gallery.utils import get_range_page
from gallery.aws import AWSManager
from gallery.decode import decode_path_gal
from gallery.forms import UGCItemForm
from gallery.pagination import UberPaginator
...
def admin_add_item_aws(request):
    if request.method == "POST":
        ...
        if not output.get('error', False):
            ...
            # Insert all tags
            ModelTag = get_model(settings.APP_SOURCE, settings.TAGS_MODEL)
