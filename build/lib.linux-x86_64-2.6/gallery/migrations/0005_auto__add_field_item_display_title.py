...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.display_title'
        db.add_column(u'gallery_item', 'display_title',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.display_title'
        db.delete_column(u'gallery_item', 'display_title')
