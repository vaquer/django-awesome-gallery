...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.display_about'
        db.add_column(u'gallery_item', 'display_about',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.display_about'
        db.delete_column(u'gallery_item', 'display_about')
    ...
    models = {
        ...
        u'gallery.item': {
            ...
            'administrator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'display_about': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
