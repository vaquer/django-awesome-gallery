...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'gallery_gallery_tags')
        ...
        db.create_table(u'gallery_item', (
            ...
            ('key_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('path', self.gf('django.db.models.fields.URLField')(max_length=250)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
            ('administrator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='items', null=True, to=orm['gallery.Gallery'])),
            ('high_definition', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        m2m_table_name = db.shorten_name(u'gallery_item_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'gallery.item'], null=False)),
            ('tag', models.ForeignKey(orm[u'app.tag'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'gallery_gallery_tags'))

        # Deleting model 'Item'
        db.delete_table(u'gallery_item')

        # Removing M2M table for field tags on 'Item'
        db.delete_table(db.shorten_name(u'gallery_item_tags'))
    ...
    models = {
        ...
        u'gallery.item': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'items'", 'null': 'True', 'to': u"orm['gallery.Gallery']"}),
            'high_definition': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_name': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'order': ('django.db.models.fields.IntegerField', [], {}),
            'path': ('django.db.models.fields.URLField', [], {'max_length': '250'}),
